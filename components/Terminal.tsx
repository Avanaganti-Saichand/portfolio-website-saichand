...
const Terminal = () => {
  ...
  const codeLines: CodeLines = useMemo(
    () => ({
      python: [
        'print("Hello, World! 👋 I\'m Saichand Avanaganti")',
        'print("Based in United States 🇺🇸")',
        'print("React Native + Node.js Developer 🚀 Building modern cross-platform apps with animations, WebSockets, and scalable backend APIs.")',
      ],
      javascript: [
        'console.log("Hello, World! 👋 I\'m Saichand Avanaganti");',
        'console.log("Based in United States 🇺🇸");',
        'console.log("React Native + Node.js Developer 🚀 Building modern cross-platform apps with animations, WebSockets, and scalable backend APIs.");',
      ],
    }),
    []
  );
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-primary">Saichand@portfolio:~$</span>
